    ...
    <div class="search-card p-4 shadow-md border-0">
        <form class="row g-3">
            ...
            <div class="col-12">
                ...
                <input type="date" class="form-control form-control-clean py-2.5 rounded-3">
            </div>
            ...
            <div class="col-12">
                ...
                <select class="form-select form-select-clean py-2.5 rounded-3">
                    <option selected>Semua Jenis Motor</option>
                    <option>Fairing</option>
                    <option>Matic</option>
                    <option>Naked</option>
                    <option>Underbone/bebek</option>
                    <option>Trail</option>
                </select>
            </div>
            
            <div class="col-12 d-grid pt-2">
                <button type="button" class="btn btn-carbon py-2.5 rounded-3 fw-bold shadow-sm">
