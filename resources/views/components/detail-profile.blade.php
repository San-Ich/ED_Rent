        ...
        <div class="col-lg-4">
            <div class="card profile-card border-0 shadow-sm rounded-4 text-center p-4 h-100">
                ...
                <div class="mb-4">
                    @if ($user->is_verified)
                        <span
                            class="badge bg-success-subtle text-success border border-success-subtle rounded-pill px-4 py-2 fw-semibold">
                            <i class="bi bi-patch-check-fill me-1 text-success"></i> Akun Terverifikasi
                        </span>
                    @else
                        <span
                            class="badge bg-warning-subtle text-warning border border-warning-subtle rounded-pill px-4 py-2 fw-semibold text-dark">
        ...
        <div class="col-lg-8">
            <div class="card profile-card border-0 shadow-sm rounded-4 p-4 p-md-5">
                <div class="d-flex align-items-center mb-4">
                    <div class="bg-carbon text-white rounded-3 p-2 me-3 shadow-sm">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="address" rows="3" class="form-control rounded-3 p-3 @error('address') is-invalid @enderror"
                                placeholder="Tuliskan alamat rumah lengkap Anda saat ini...">{{ old('address', $user->address) }}</textarea>
                            @error('address')
                                <div class="invalid-feedback d-block small">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="p-3 rounded-4 doc-preview-box text-center">
                                @if ($user->ktp_path)
                                    <div class="mb-3">
                        ...
                        <div class="col-12 text-end mt-5">
                            <button type="submit"
                                class="btn btn-carbon btn-md rounded-pill px-5 py-2.5 fw-bold shadow-sm transition-all">
