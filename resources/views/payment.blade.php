...
@section('content')
    ...
    <script type="text/javascript">
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const isDenda = {{ $isDenda ? 'true' : 'false' }};
                ...
                payButton.addEventListener('click', function(event) {
                    ...
                    window.snap.pay('{{ $snapToken }}', {
                        ...
                        onSuccess: function(result) {
                            let successUrl = "{{ route('payment.success', $rental->id) }}";

                            if (isDenda) {
                                successUrl += "?type=denda&order_id=" + result.order_id;
                            } else {
                                successUrl += "?order_id=" + result.order_id;
                            }
                        ...
                        onPending: function(result) {
                            if (result.transaction_status === 'expire' || result
